        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-slate-500 text-base leading-relaxed">
              Prestigious address options in Sweden's two largest business
              cities.
            </p>
          </div>
        </div>
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col justify-between">
              <div>
                <h3 className="text-lg font-bold text-[#0a1628] mb-2">
                  Stockholm Flagship Address
                </h3>
                <p className="text-slate-500 text-sm leading-relaxed mb-5">
                  Position your company in the prestigious business district of
                  Östermalm. Ideal for tech startups, premium consulting firms,
                  and established corporate brands looking for top-tier
                  branding.
                </p>
                <div className="mb-5">
          ...
          <div className="reveal reveal-delay-1 group bg-white rounded-3xl border border-[#E1EDF8] overflow-hidden shadow-[0_4px_20px_rgba(5,167,244,0.06)] hover:shadow-[0_12px_40px_rgba(5,167,244,0.12)] transition-all duration-400 flex flex-col">
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-500 text-sm leading-relaxed mb-5">
                  Set up a local presence in Sweden's industrial capital and
                  largest shipping port. Outstanding logistics access, perfect
                  for trade companies, e-commerce brands, and regional support
                  offices.
                </p>
                <div className="mb-5">
                  <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">
